...
async function main() {
  ...
  // function: update the clock with the current time in city's local time
  function updateClockAndSunPosition(
    TimezoneOffset,
    sunsetTimestamp,
    sunriseTimestamp
  ) {
    ...
    var currentTimeStamp =
      Math.floor(Date.now() / 1000) + TimezoneOffset * 3600;
    ...
    if (currentMinutes > sunriseMinutes && currentMinutes < sunsetMinutes) {
      ...
      var runningTime =
        (currentMinutes > sunsetMinutes
          ? currentMinutes - sunsetMinutes
          : 1440 + currentMinutes - sunsetMinutes) / 60;
    ...
    var currentDateFormatted = currentDateTime.toLocaleDateString("de-DE", {
      weekday: "short",
      year: "numeric",
      month: "short",
      day: "numeric",
